...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers-deepseek-v4:executing-plans to implement this plan task-by-task.
 ...
 *
 * @param {string} skillName - Name like "superpowers-deepseek-v4:brainstorming" or "my-skill"
 * @param {string} superpowersDir - Path to superpowers skills directory
 * @param {string} personalDir - Path to personal skills directory
 * @returns {{skillFile: string, sourceType: string, skillPath: string} | null}
 */
function resolveSkillPath(skillName, superpowersDir, personalDir) {
    // Strip superpowers-deepseek-v4: prefix if present
    const forceSuperpowers = skillName.startsWith('superpowers-deepseek-v4:');
    const actualSkillName = forceSuperpowers ? skillName.replace(/^superpowers-deepseek-v4:/, '') : skillName;

    // Try personal skills first (unless explicitly superpowers-deepseek-v4:)
    ...
    tools: [
      {
        ...
        schema: z.object({
          skill_name: z.string().describe('Name of the skill to load (e.g., "superpowers-deepseek-v4:brainstorming" or "my-custom-skill")')
        }),
...
```javascript
      {
        ...
        execute: async () => {
          ...
          for (const skill of allSkills) {
            const namespace = skill.sourceType === 'personal' ? '' : 'superpowers-deepseek-v4:';
...
**Skills naming:**
- Superpowers skills: \`superpowers-deepseek-v4:skill-name\` (from ~/.config/opencode/superpowers/skills/)
...
**Below is the full content of your 'superpowers-deepseek-v4:using-superpowers' skill - your introduction to using skills. For all other skills, use the 'use_skill' tool:**
...
```
use use_skill tool with skill_name: "superpowers-deepseek-v4:brainstorming"
```
...
Run: `.codex/superpowers-codex use-skill superpowers-deepseek-v4:brainstorming | head -20`
